 ...
 * 
 */
public class PendingTransactionsAction extends AccountAbstractAction {
	...
	public PendingTransactionsAction(BankGraphicInterface bankInterface,
		...
		super.putValue(Action.NAME, textManager.getText("action.pendingTransaction"));
	}
